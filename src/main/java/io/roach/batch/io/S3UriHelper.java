...
public class S3UriHelper {
     ...
     */
    public S3UriHelper(final String str) {
        this(str, true);
    }
     ...
     */
    public S3UriHelper(final String str, final boolean urlEncode) {
     ...
     */
    public S3UriHelper(final URI uri) {
        this(uri, false);
    }

    private S3UriHelper(final URI uri, final boolean urlEncode) {
        if (uri == null) {
    ...
    public static S3UriHelper create(String uri) {
        return new S3UriHelper(uri);
    }
    ...
    public boolean equals(Object o) {
        ...
        S3UriHelper that = (S3UriHelper) o;
